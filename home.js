...
var huamake = {
	...
	sequence : function () {
		...
		} else if ( huamake.loadingpage == "discussionnew" ) {
				huamake.ajaxcalls -= 1;
				//alert( huamake.ajaxcalls );
				if( huamake.ajaxcalls == 1 ) {
					$( "#discuss" ).load( "./" + thePage + ".htm" );
				}
				if( huamake.ajaxcalls == 0 && huamake.initedPages[ "discussionnew" ]  == undefined  ) { 
					huamake.initedPages[ "discussionnew" ] = 1;
				} 
	...
	loadpage : function ( thePage ) {
		...
		if( thePage == "web2_0new" ) {
			...
			*/
			...
			huamake.initedPages[ thePage ] = 1;
		} else if ( thePage == "discussionnew" ) {
			huamake.ajaxcalls = 3;
			huamake.fetchscript( "./js/jquery.treeTable.js" );
			huamake.fetchscript( "./discussion.js" );
		} else {
			return;
		}
