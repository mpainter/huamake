...
/* 
ALL server side application logic for processing data posted by the user to threaded discussions is contained in this class.
...
The lower level class, huamakedb will be used to actually perform database operations.
*/
	private $db;
	private $conn;
	private $result;
