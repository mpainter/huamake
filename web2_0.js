  ...
  xmlhttp.onreadystatechange=function()
    {
     if(xmlhttp.readyState==4)
		...
		if( xmlhttp.status == 200 ) {
			...
			//alert( "testElementLinks call" );
			testElementLinks( meat, otherElements );
			//alert( "testElementLinks return" );
 			changecur( "commonelement", theCommonElement );
 			if( xmlDoc ) {
...
function skipto( event ) 
{
	...
	if(event && event.id ) {
		...
		if( i < theCharList.length ) {
			...
			fetchotherelements( theCharCode, "otherelements", "" );
			if( godeep != 0 ) {
				fetchTheCharList( theCommonElementId );
			} else {
...
function initpage() 
{
	...
	mybox = document.getElementById( "godeep" );
	if( mybox ) {
		tmpStr = window.location.search.substring(1);
		tmpInt = tmpStr.indexOf( "godeep" );
		mybox.checked= null;
		godeep = 0;
		if( tmpInt != -1 ) {
			tmpStr = tmpStr.substr( tmpInt + 7 );
			if( tmpStr.charAt( 1 ) == 'n' ) {
				godeep = 1;
				mybox.checked = "true";
				mycheck( mybox );
			}
	...
	inithanconvert();
	tmpStr = window.location.search.substring(1);
	tmpInt = tmpStr.indexOf( "demo=1" );
	if( tmpInt != -1 ) {
		// start running the demo
		//alert( "demo" );
		window.scrollBy( 0, 150 );
		var demoanimationsteps = new Array();
		demoanimationsteps[0] = { id1: "#u82D7_li", id1class: "animtext", id2: "#demoanim1", id2cont: "#charlist"};
		demoanimationsteps[1] = { id1: "#u82D7_li", id1class: "animtext", id2: "#demoanim1", id2cont: "#charlist"};
		demoanimationsteps[2] = { id1: "#u82D7_li", id1class: "animtext", id2: "#demoanim2", id2cont: "#charlist",
action: function() { skipto( document.getElementById("u82D7_li") );} };
		demoanimationsteps[3] = { id1: "#u732B_li", id1class: "animtext", id2: "#demoanim2", id2cont: "#charlist" };
		demoanimationsteps[4] = { id1: "#u732B_li", id1class: "animtext", id2: "#demoanim2", id2cont: "#charlist",
action: function() {skipto( document.getElementById("u732B_li" ) );} };
		demoanimationsteps[5] = { id1: "#u732B_li", id1class: "animtext", id2: "#demoanim3", id2cont: "#charlist" };
		demoanimationsteps[6] = { id1: "#thechar", id1class: "animtext", id2: "#demoanim4", id2cont: ".displayarea",
action: function() {window.location='http:./home.htm?thePage=baseindexnew';} };
		demoanimationsteps.active = true;
		animatedemo( -1, demoanimationsteps, 5000 ); 
	} 
